...
This directory is the canonical public archive of Anni McHenry's Twitter/X posts, in the public-writing source repository. It contains sanitized export records and reviewed public-profile observations.

The September 2026 repository moves are documented in [REPOSITORY-LINEAGE.md](REPOSITORY-LINEAGE.md). Raw source exports and private review batches are not part of this public tree.
...
The September 14 repair preserves 3,364 exact post/event records plus 101 separately counted public repost observations. [Count reconciliation and collection corrections](sync/2026-09-14-review.md#gap-repair--september-14-2026).
